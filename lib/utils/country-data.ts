/**
 * Every country, with its dialling code.
 *
 * Format of one entry: "CODE|Name|dialling code|local digit lengths".
 * The last part is how many digits the number has after the dialling code.
 * It is only filled in for the countries our attendees use, because it is
 * only needed to spot a pasted number that already has the dialling code in
 * front. An entry with no last part still works, it is just less exact.
 */
export const COUNTRY_TABLE: string[] = [
  ...
  "AR|Argentina|54", "AM|Armenia|374", "AW|Aruba|297", "AU|Australia|61|9",
  ...
  "BR|Brazil|55", "VG|British Virgin Islands|1", "BN|Brunei|673",
  "BG|Bulgaria|359", "BF|Burkina Faso|226", "BI|Burundi|257", "KH|Cambodia|855",
  "CM|Cameroon|237", "CA|Canada|1|10", "CV|Cape Verde|238",
  ...
  "CR|Costa Rica|506", "HR|Croatia|385", "CU|Cuba|53", "CW|Curacao|599",
  ...
  "EE|Estonia|372", "SZ|Eswatini|268", "ET|Ethiopia|251", "FJ|Fiji|679",
  ...
  "GL|Greenland|299", "GD|Grenada|1", "GU|Guam|1", "GT|Guatemala|502",
  ...
  "IS|Iceland|354", "IN|India|91|10", "ID|Indonesia|62", "IR|Iran|98",
  "IQ|Iraq|964", "IE|Ireland|353", "IM|Isle of Man|44", "IL|Israel|972",
  "IT|Italy|39", "CI|Ivory Coast|225", "JM|Jamaica|1", "JP|Japan|81",
  ...
  "MY|Malaysia|60|9,10", "MV|Maldives|960", "ML|Mali|223", "MT|Malta|356",
  ...
  "NZ|New Zealand|64|8,9", "NI|Nicaragua|505", "NE|Niger|227", "NG|Nigeria|234",
  ...
  "PH|Philippines|63", "PL|Poland|48", "PT|Portugal|351", "PR|Puerto Rico|1",
  "QA|Qatar|974|8", "RE|Reunion|262", "RO|Romania|40", "RU|Russia|7",
  ...
  "SG|Singapore|65|8", "SK|Slovakia|421", "SI|Slovenia|386",
  "SB|Solomon Islands|677", "SO|Somalia|252", "ZA|South Africa|27",
  "KR|South Korea|82", "SS|South Sudan|211", "ES|Spain|34", "LK|Sri Lanka|94|9",
  ...
  "TM|Turkmenistan|993", "TC|Turks and Caicos Islands|1", "TV|Tuvalu|688",
  "UG|Uganda|256", "UA|Ukraine|380", "AE|United Arab Emirates|971|9",
  "GB|United Kingdom|44|10", "US|United States|1|10", "UY|Uruguay|598",
  "VI|US Virgin Islands|1", "UZ|Uzbekistan|998", "VU|Vanuatu|678",
  "VA|Vatican City|379", "VE|Venezuela|58", "VN|Vietnam|84", "YE|Yemen|967",
  "ZM|Zambia|260", "ZW|Zimbabwe|263",
];

/** Shown at the top of the dropdown. Most attendees live in these. */
export const PINNED_COUNTRY_CODES = ["AU", "IN", "MY", "SG"];
